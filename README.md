...
```bash 
sudo yum install -y https://cloudify-release-eu.s3-eu-west-1.amazonaws.com/cloudify/cloudify-cluster-manager/1.0.1/ga-release/cloudify-cluster-manager-1.0.1-ga.el7.x86_64.rpm
